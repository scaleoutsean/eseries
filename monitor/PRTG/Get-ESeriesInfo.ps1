...
if ($UsePowerShell7Wrapper) {
    ...
    Invoke-ESeriesPrtgPs7Wrapper -Mode 'system' -ApiEp $ApiEp -ApiPort $ApiPort -SanSysId $SanSysId -Account $Account -Password $Password -PwshPath $PwshPath -SantricityModulePath $SantricityModulePath
}
